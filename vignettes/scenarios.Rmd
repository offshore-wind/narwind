...
downloadthis::download_link(
  link = "https://raw.githubusercontent.com/offshore-wind/narwind/0a45ae03f1938cd5396895b943b8615f28812669/vignettes/pdf/2%20Defining%20scenarios.pdf",
...
Ticking the `Vessel strike risk` checkbox prompts the user to choose whether they wish to display a baseline vessel strike risk layer or a scenario vessel strike risk layer (relating to the scenario selected on the Scenario Selection tab). The user should also select which month they wish to visualize. The `Update map` button should be clicked to display the selected vessel strike risk surface.
